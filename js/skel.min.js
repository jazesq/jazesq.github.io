  ...
  var e = "breakpoints",
    ...
    nn = {
      ...
      extend: function (e, t) {
        ...
        nn[n](t, function (n) {
          nn[P](t[n])
            ? (nn[P](e[n]) || (e[n] = []), nn[X](e[n], t[n]))
            : typeof t[n] == D
            ? (typeof e[n] != D && (e[n] = {}), nn[X](e[n], t[n]))
            : (e[n] = t[n]);
        });
      },
      getArray: function (e) {
      ...
      applyRowTransforms: function (e) {
        ...
        (a = nn[o]("important(collapse)")),
          ...
          nn[n](i, function (n) {
            ...
            if (!o) return;
            if (!s[$t](r) || s[r] === u) {
              e[t][B][At] && s[M][H](/important\(collapse\)/)
                ? (l = "c")
                : s[M][H](/important\((.+)\)/) &&
                  (h = parseInt(nn[L].v[RegExp.$1])) <= e[t][B][ct] &&
                  (l = "l");
              if (!l) return;
              ...
              o[E](s, nn[t].RTL && l == "l" ? o.lastChild : o[Bt]),
                (s[r] = { placeholder: a, mode: l, level: h });
            } else {
              (a = s[r][lt]), (l = s[r].mode);
              if (
                (l == "c" && e[t][B][At]) ||
      ...
      changeState: function (o) {
        ...
        if (!nn[C][bt][nn[i]]) {
          (nn[C][bt][nn[i]] = { config: {}, elements: [], values: {} }),
            (c = nn[C][bt][nn[i]]),
          ...
          (g = nn[nt](c[t][J])),
            ...
            (c.values[J] = M + D),
            (k = "iC" + c.values[J]),
            D.substr(-1) == "!" && ((P = y), (D = D.substr(0, D[f] - 1))),
            (E = nn[h](k)) ||
              (E = nn[v](
                k,
                nn[S](
          ...
          nn[n](a, function (i) {
            nn[e][a[i]][t][Gt] &&
              ((k = "ss" + a[i]),
              (E = nn[h](k)) ||
                (E = nn[v](k, nn.newStyleSheet(nn[e][a[i]][t][Gt]), I, 5)),
              c[r][W](E)),
              nn[e][a[i]][r][f] > 0 &&
                nn[n](nn[e][a[i]][r], function (t) {
                  c[r][W](nn[e][a[i]][r][t]);
                });
          }),
            nn[C][s][nn[i]] &&
              (nn[n](nn[C][s][nn[i]], function (e) {
                c[r][W](nn[C][s][nn[i]][e]);
              }),
              (nn[C][s][nn[i]] = []));
        } else c = nn[C][bt][nn[i]];
      ...
      poll: function () {
        ...
        (e = nn.getStateId()),
          ...
          e !== nn[i] &&
            (nn[pt]
              ? nn.changeState(e)
              : ((nn[k][Pt][M] = nn[k][Pt][M][F](
                  nn[i][x](1)[F](new RegExp(nn.sd, "g"), " "),
                  ""
                )),
                nn.changeState(e),
                (nn[k][Pt][M] =
      ...
      initAPI: function () {
        ...
        (nn[w][ut] = 99),
          ...
          r[H](/Firefox/)
            ...
            : r[H](/Chrome/)
            ? (e = "chrome")
            : r[H](/Safari/) && !r[H](/Chrome/)
            ? (e = "safari")
            : r[H](/(OPR|Opera)/)
            ? (e = "opera")
            : r[H](/MSIE ([0-9]+)/)
            ? ((e = "ie"), (nn[w][ut] = RegExp.$1))
            : r[H](/Trident\/.+rv:([0-9]+)/) &&
              ((e = "ie"), (nn[w][ut] = RegExp.$1)),
          (nn[w].browser = e),
          (nn[w][O] = "other"),
        ...
        (nn[w].deviceVersion = e),
          ...
          (nn[w].isMobile =
            nn[w][O] == "wp" || nn[w][O] == Zt || nn[w][O] == "ios"),
      ...
      initConfig: function (i) {
        ...
        if (!i || !(e in i))
          (nn[pt] = y),
            ...
            (nn[t][p].height = ""),
            (nn[t][p].scalable = y);
        typeof i == D && (i[e] && (nn[t][e] = {}), nn[X](nn[t], i)),
          B in nn[t] &&
            b in nn[t][B] &&
            !nn[P](nn[t][B][b]) &&
            (nn[t][B][b] = [nn[t][B][b], nn[t][B][b]]),
            ...
            nn[X](s, nn[t][e][n]),
              ...
              "range" in s &&
                ...
                u == "*"
                  ? (a = "")
                  : u[it](0) == "-"
                  ? (a = "(max-width: " + parseInt(u[x](1)) + "px)")
                  : u[it](u[f] - 1) == "-"
                  ? (a = Dt + parseInt(u[x](0, u[f] - 1)) + "px)")
                  : nn[U](u, "-") != -1 &&
                    ((u = u[xt]("-")),
                    (a =
                      Dt +
                ...
                (s[Mt] = a)),
              B in s &&
                (b in s[B] && !nn[P](s[B][b]) && (s[B][b] = [s[B][b], s[B][b]]),
        ...
        (nn.me = e[e[f] - 1]),
          ...
          nn[w].browser == "ie" &&
            ...
            nn[dt](
              nn[q](
                "msie-viewport-fix",
                nn[S]("@-ms-viewport{width:device-width}"),
                et,
                1
              )
            );
